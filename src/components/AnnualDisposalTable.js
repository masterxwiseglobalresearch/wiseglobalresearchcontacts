            ...
            >
              ...
              <thead>
                <tr className="bg-gray-50">
                  ...
                  <th scope="col" className="p-2 sm:p-3 text-center min-w-[120px]" style={{ color: '#111' }}>Year</th>
                  <th scope="col" className="p-2 sm:p-3 text-center min-w-[180px]" style={{ color: '#111' }}>Carried forward from previous year</th>
              ...
              <tbody>
                {(Array.isArray(tableData) ? tableData : Object.values(tableData || {})).map(row => (
                  <tr key={row.srNo} className="transition-colors hover:bg-gray-50" style={{ backgroundColor: '#fff' }}>
                    ...
                    <td data-label="Year" className="p-2 sm:p-3 text-center min-w-[120px]">{row.year}</td>
                    <td data-label="Carried forward from previous year" className="p-2 sm:p-3 text-center min-w-[180px]">{row.carried}</td>
